...
bzip2.executable =  spec_prefix + 'bzip2' + x86_suffix
# TEST CMDS
...
gcc.executable = spec_prefix + 'gcc' + x86_suffix
# TEST CMDS
...
gamess.executable = spec_prefix + 'gamess' + x86_suffix
# TEST CMDS
...
milc.executable = spec_prefix + 'milc' + x86_suffix
# TEST CMDS
...
zeusmp.executable = spec_prefix + 'zeusmp' + x86_suffix
# TEST CMDS
...
gromacs.executable = spec_prefix + 'gromacs' + x86_suffix
# TEST CMDS
...
cactusADM.executable = spec_prefix + 'cactusADM' + x86_suffix
# TEST CMDS
...
leslie3d.executable = spec_prefix + 'leslie3d' + x86_suffix
# TEST CMDS
...
gobmk.executable = spec_prefix + 'gobmk' + x86_suffix
# TEST CMDS
...
dealII.executable = spec_prefix + 'dealII' + x86_suffix
# TEST CMDS
####### NOT WORKING #########
...
soplex.executable = spec_prefix + 'soplex' + x86_suffix
# TEST CMDS
...
calculix.executable = spec_prefix + 'calculix' + x86_suffix
# TEST CMDS
...
hmmer.executable = spec_prefix + 'hmmer' + x86_suffix
# TEST CMDS
...
sjeng.executable = spec_prefix + 'sjeng' + x86_suffix
# TEST CMDS
...
GemsFDTD.executable = spec_prefix + 'GemsFDTD' + x86_suffix
# TEST CMDS
...
libquantum.executable = spec_prefix + 'libquantum' + x86_suffix
# TEST CMDS
...
h264ref.executable = spec_prefix + 'h264ref' + x86_suffix
# TEST CMDS
...
tonto.executable = spec_prefix + 'tonto' + x86_suffix
# TEST CMDS
...
astar.executable = spec_prefix + 'astar' + x86_suffix
# TEST CMDS
...
sphinx3.executable = spec_prefix + 'sphinx_livepretend' + x86_suffix
# TEST CMDS
...
xalancbmk.executable = spec_prefix + 'xalancbmk' + x86_suffix
# TEST CMDS
######## NOT WORKING ###########
...
specrand_i.executable = spec_prefix + 'specrand' + x86_suffix
# TEST CMDS
...
specrand_f.executable = spec_prefix + 'specrand' + x86_suffix
# TEST CMDS
